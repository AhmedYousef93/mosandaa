    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('action', function ($row) {
            ...
            if (Auth::guard('admin')->user()->hasPermission('areas-update')){
                ...
                data-target="#modal-edit-area" data-areaid="'.$row->id.'" data-title_ar="'.$row->title_ar.'" data-title_en="'.$row->title_en.'"><i data-feather="edit"></i></button> &nbsp;';
               }else{
            ...
            if (Auth::guard('admin')->user()->hasPermission('areas-delete')){
                $btn = $btn.
                '<form class="delete"  action="' . route("areas.destroy", $row->id) . '"  method="POST" id="delform"
